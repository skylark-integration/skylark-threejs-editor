define([
    ...
    var SidebarGeometryOctahedronGeometry = function (editor, object) {
        ...
        radiusRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/octahedron_geometry/radius')).setWidth('90px'));
        ...
        detailRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/octahedron_geometry/detail')).setWidth('90px'));
        detailRow.add(detail);
        container.add(detailRow);
        function update() {
            editor.execute(new SetGeometryCommand(editor, object, new THREE.OctahedronBufferGeometry(radius.getValue(), detail.getValue())));
            signals.objectChanged.dispatch(object);
        }
        return container;
    };
    return SidebarGeometryOctahedronGeometry;
});