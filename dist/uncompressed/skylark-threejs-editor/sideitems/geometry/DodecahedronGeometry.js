define([
    ...
    var SidebarGeometryDodecahedronGeometry = function (editor, object) {
        ...
        radiusRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/dodecahedron_geometry/radius')).setWidth('90px'));
        ...
        detailRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/dodecahedron_geometry/detail')).setWidth('90px'));
        detailRow.add(detail);
        container.add(detailRow);
        function update() {
            editor.execute(new SetGeometryCommand(editor, object, new THREE.DodecahedronBufferGeometry(radius.getValue(), detail.getValue())));
        }
        return container;
    };
    return SidebarGeometryDodecahedronGeometry;
});