define([
    ...
    var SidebarGeometryIcosahedronGeometry = function (editor, object) {
        ...
        radiusRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/icosahedron_geometry/radius')).setWidth('90px'));
        ...
        detailRow.add(new mrdoobui.UIText(strings.getKey('sidebar/geometry/icosahedron_geometry/detail')).setWidth('90px'));
        detailRow.add(detail);
        container.add(detailRow);
        function update() {
            editor.execute(new SetGeometryCommand(editor, object, new THREE.IcosahedronBufferGeometry(radius.getValue(), detail.getValue())));
            signals.objectChanged.dispatch(object);
        }
        return container;
    };
    return SidebarGeometryIcosahedronGeometry;
});